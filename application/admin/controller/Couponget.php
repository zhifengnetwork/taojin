...
class Couponget extends Common
{
    ...
    public function index(){
        ...
        if(request()->isPost()){
            ...
            return $this->fetch('couponget/index');
        }
    }
    ...
    public function edit(){
        ...
        //leapmary广告位//
        $extensionbit = db('extensionbit')->find();
        $this->assign('adzoneid',$extensionbit['adzoneid']);
        ...
        return $this->fetch('couponget/edit');
    ...
    public function coupongetdo(){
        ...
        $id = input('id');
        //采集商品
        $re = action('common/Goods/get_goods_from_ali_api',['id'=>$id]);
        print_r($re);
