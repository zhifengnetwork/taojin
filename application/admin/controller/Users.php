    ...
    public function index(){
        if(request()->isPost()){
            ...
            $list = db('users')->alias('u')
                ...
                ->field('u.id,u.nick_name,u.balance,u.recharge_balance,u.lock_balance,u.integral,u.currency,u.lock_currency,ul.level_name,u.phone,u.add_time,p.phone as p_phone')
