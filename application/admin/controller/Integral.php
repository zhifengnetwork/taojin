...
class Integral extends Common
{
    ...
    public function edit(){
        ...
        return $this->fetch('integral/edit');
    }
    ...
    public function exchange_log(){
        ...
        if(request()->isPost()){
            ...
            return $this->fetch('integral/exchange_log');
        }
    }
     ...
     * 发货
     */
    public function exchange_deliver(){

        $id = input('id');
        $re = db('exchange_log')->where("id",$id)->update([
            'type' => 2
        ]);
