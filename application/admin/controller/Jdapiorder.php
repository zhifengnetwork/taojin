...
class Jdapiorder extends Common
{
    ...
    public function index(){
        ...
        if(request()->isPost()){
            ...
            return $this->fetch('jdapiorder/index');
        }
    }
    ...
    public function edit(){
        ...
        return $this->fetch('jdapiorder/edit');
    }
    ...
    public function do_rebate(){
        ...
        $data['user_info'] = action('common/User/getuserinfo',['token' => '','u_id' => $u_id]);
        ...
        $data['jdapiorder'] = db('jdapiorder')
            ->where('orderid',$orderid)
            ->find();

        /*print_r($data);exit;*/

        $rebate_re = action('common/User/addmoney',['type'=>2,'data'=>$data]);
