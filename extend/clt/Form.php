...
class Form
{
    ...
    public function text($info,$value){
        ...
        $parseStr = '<input ' . $info['readonly'] . ' type="' . $inputtext . '" data-required="' . $info['required'] . '" min="' . $info['minlength'] . '" max="' . $info['maxlength'] . '" errormsg="' . $info['errormsg'] . '" title="' . $name . '" placeholder="请输入' . $name . '" lay-verify="defaul' . $pattern . '" class="' . $info['class'] . ' layui-input" name="' . $field . '" value="' . $value . '" /> ';
        if($info['required'] == 1){
            $parseStr .= '</div>';
    ...
    public function number($info,$value){
        ...
        //leapmary这里产生输入框//
        $parseStr = '<input ' . $info['readonly'] . ' type="' . $inputtext . '"   class="input-text ' . $info['class'] . ' layui-input" name="' . $field . '"  id="' . $id . '" value="' . $value . '" size="' . $size . '"  ' . $validate . '/> ';
